...
class OnnxCore:
    """Common ONNX runtime engine module for text classification."""
    ...
    def setup(self) -> None:
        ...
        # text_size tergantung pada file onnx-nya (lihat di netron)
        # digunakan nanti waktu padding
        self.text_size = self.metadata[0].input_shape[1]
